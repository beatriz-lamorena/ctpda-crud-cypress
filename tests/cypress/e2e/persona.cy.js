...
describe('Relacionar representante a persona tipo jurídicas', () => {
    it('Debería relacionar un representante a una persona tipo jurídica desde el formulario', () => {
        navegarLogin();
        //Entrar en el apartado de personas y validarlo
        ...
        cy.wait(2000);
        cy.xpath("//button[@id='formFormulario:tablaNuevosRepresentantes:0:seleccionarRepre']/span").should('be.visible').and('have.text', 'representante').first().click();
